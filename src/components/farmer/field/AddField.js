...
export default class AddField extends Component {
  ...
  <Card.Title>
          ...
          <Form.Control type="text" name="location" className="m-3" value={this.state.location} onChange={this.handleChange} />
      
          <strong>Size of the field:</strong>
          <Form.Control type="number" name="size" className="m-3" value={this.state.size} onChange={this.handleChange} />ha <>&nbsp;</><>&nbsp;</>
          <strong>Polygon:</strong>
          <Form.Control type="text" name="polygon" className="m-3" value={this.state.polygon} onChange={this.handleChange} />
          
          </Card.Text>
          <Button type="submit" size="lg" value="Submit" variant="primary">Create Field</Button>
        </Form>
  </Card.Body>
</Card>
